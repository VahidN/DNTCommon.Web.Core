...
public class ScheduledTasksStorage
{
    ...
    /// </summary>
    public void AddPingTask(string siteRootUrl) => SiteRootUrl = siteRootUrl;
    ...
    /// </param>
    public void AddScheduledTask<T>(Func<DateTime, bool> runAt, int order = 1)
    ...
    public void RemoveScheduledTask<T>()
        where T : IScheduledTask
    {
