...
public class ScheduledTaskStatus
{
    ...
    public override bool Equals(object? obj)
    {
        ...
        return obj is ScheduledTaskStatus asThis && asThis.TaskType == TaskType;
    }
    ...
    /// </summary>
    /// <returns></returns>
    public override int GetHashCode() => TaskType.GetHashCode();

    /// <summary>
    ///     Gets the fully qualified name of the type, including its namespace but not its assembly.
    /// </summary>
    /// <returns></returns>
    public override string? ToString() => TaskType.FullName;
}