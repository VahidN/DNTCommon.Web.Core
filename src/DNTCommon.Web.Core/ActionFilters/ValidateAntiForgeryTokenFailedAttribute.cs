...
///     regardless of other filters. It checks if the result of the action is an
///     <see cref="IAntiforgeryValidationFailedResult" />
...
public sealed class ValidateAntiForgeryTokenFailedAttribute([StringSyntax(syntax: "Uri")] string redirectUrl)
    : Attribute, IAlwaysRunResultFilter
{
    /// <summary>
    ///     The URL to redirect to when Antiforgery token validation fails.
    ///     It's recommended to be a page displaying a user-friendly error message.
