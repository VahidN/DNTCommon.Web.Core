...
public class MailHeaders
{
    ...
    ///     The Message-Id is meant to be a globally unique identifier for a message. MimeKit.Utils.MimeUtils.GenerateMessageId
    ///     can be used to generate this value.
    ...
    ///     If the message is a reply to another message, it will typically use the In-Reply-To header to specify the
    ...
    /// </summary>
    public string? UnSubscribeUrl { set; get; }
}