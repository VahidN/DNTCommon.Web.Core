...
public static class IdentityExtensions
{
    ...
    ///     Extracts the `ClaimTypes.NameIdentifier`'s value of the given IIdentity.
    /// </summary>
    public static string? GetUserId(this IIdentity identity) => identity?.GetUserClaimValue(ClaimTypes.NameIdentifier);
    ...
    /// </summary>
    public static string? GetUserLastName(this IIdentity identity) => identity?.GetUserClaimValue(ClaimTypes.Surname);
    ...
    /// </summary>
    public static string? GetUserName(this IIdentity identity) => identity?.GetUserClaimValue(ClaimTypes.Name);
}